...
namespace WIAegisViolations.Finders
{
    public class LacrosseFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://lacrosse.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "La Crosse");
        public string Name => "La Crosse";
        public string State => "WI";
        public string Link => "https://lacrosse.t2hosted.com";
