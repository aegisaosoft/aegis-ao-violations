...
{
    public class FarmingdaleFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://farmingdale.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Farmingdale State College (SUNY)");
        public string Name => "Farmingdale State College (SUNY)";
        public string State => "NY";
        public string Link => "https://farmingdale.t2hosted.com";
