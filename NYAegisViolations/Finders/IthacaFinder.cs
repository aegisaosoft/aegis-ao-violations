...
{
    public class IthacaFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://ithaca.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Ithaca College");
        public string Name => "Ithaca College";
        public string State => "NY";
        public string Link => "https://ithaca.t2hosted.com";
