...
{
    public class CornellTransportationFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://cornelltransportation.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Cornell University (Ithaca)");
        public string Name => "Cornell University (Ithaca)";
        public string State => "NY";
        public string Link => "https://cornelltransportation.t2hosted.com";
