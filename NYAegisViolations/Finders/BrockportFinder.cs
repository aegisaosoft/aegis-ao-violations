...
{
    public class BrockportFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://brockport.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "SUNY Brockport");
        public string Name => "SUNY Brockport";
        public string State => "NY";
        public string Link => "https://brockport.t2hosted.com";
