...
{
    public class ManhattanFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://manhattan.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Manhattan University (Bronx)");
        public string Name => "Manhattan University (Bronx)";
        public string State => "NY";
        public string Link => "https://manhattan.t2hosted.com";
