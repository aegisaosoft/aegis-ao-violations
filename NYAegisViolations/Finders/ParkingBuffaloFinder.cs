...
{
    public class ParkingBuffaloFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://parking-buffalo.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "University at Buffalo");
        public string Name => "University at Buffalo";
        public string State => "NY";
        public string Link => "https://parking-buffalo.t2hosted.com";
