...
{
    public class RitFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://rit.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Rochester Institute of Technology (RIT)");
        public string Name => "Rochester Institute of Technology (RIT)";
        public string State => "NY";
        public string Link => "https://rit.t2hosted.com";
