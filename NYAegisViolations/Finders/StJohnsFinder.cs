...
{
    public class StJohnsFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://stjohns.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "St. John's University (Queens)");
        public string Name => "St. John's University (Queens)";
        public string State => "NY";
        public string Link => "https://stjohns.t2hosted.com";
