...
namespace NJAegisViolations.Finders
{
    public class NjitFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://njit.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "NJIT");
        public string Name => "NJIT";
        public string State => "NJ";
        public string Link => "https://njit.t2hosted.com";
