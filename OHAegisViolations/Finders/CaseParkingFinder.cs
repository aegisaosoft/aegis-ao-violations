...
namespace OHAegisViolations.Finders
{
    public class CaseParkingFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://caseparking.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Case Western Reserve University");
        public string Name => "Case Western Reserve University";
        public string State => "OH";
        public string Link => "https://caseparking.t2hosted.com";
