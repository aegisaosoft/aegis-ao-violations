...
{
    public class ViolationsParkingFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://violationsparking.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Columbus");
        public string Name => "Columbus";
        public string State => "OH";
        public string Link => "https://violationsparking.t2hosted.com";
