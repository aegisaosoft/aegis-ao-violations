...
namespace COAegisViolations.Finders
{
    public class FcgovFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://fcgov.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Fort Collins");
        public string Name => "Fort Collins";
        public string State => "CO";
        public string Link => "https://fcgov.t2hosted.com";
