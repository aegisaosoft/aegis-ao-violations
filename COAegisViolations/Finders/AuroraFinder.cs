...
{
    public class AuroraFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://aurora.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Aurora");
        public string Name => "Aurora";
        public string State => "CO";
        public string Link => "https://aurora.t2hosted.com";
