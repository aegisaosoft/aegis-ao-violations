...
/// <summary>
/// Response model for complete payments
/// </summary>
public class CompletePaymentsResponse
{
    /// <summary>
    /// Array of complete payment records
    /// </summary>
    [JsonProperty("result")]
    public List<CompletePayment> Result { get; set; } = new();
...
/// <summary>
/// Individual complete payment record
/// </summary>
