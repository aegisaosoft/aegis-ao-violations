...
namespace WAAegisViolations.Finders
{
    public class CityOfVancouverFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://cityofvancouver.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Vancouver");
        public string Name => "Vancouver";
        public string State => "WA";
        public string Link => "https://cityofvancouver.t2hosted.com";
