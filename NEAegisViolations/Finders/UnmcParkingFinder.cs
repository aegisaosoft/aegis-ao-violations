...
{
    public class UnmcParkingFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://unmcparking.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "University of Nebraska Medical Center");
        public string Name => "University of Nebraska Medical Center";
        public string State => "NE";
        public string Link => "https://unmcparking.t2hosted.com";
