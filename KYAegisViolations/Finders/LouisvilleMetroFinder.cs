...
namespace KYAegisViolations.Finders
{
    public class LouisvilleMetroFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://louisvillemetro.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Louisville");
        public string Name => "Louisville";
        public string State => "KY";
        public string Link => "https://louisvillemetro.t2hosted.com";
