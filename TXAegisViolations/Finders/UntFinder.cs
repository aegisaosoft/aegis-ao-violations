...
{
    public class UntFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://unt.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "University of North Texas");
        public string Name => "University of North Texas";
        public string State => "TX";
        public string Link => "https://unt.t2hosted.com";
