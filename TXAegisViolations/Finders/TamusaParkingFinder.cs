...
namespace TXAegisViolations.Finders
{
    public class TamusaParkingFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://tamusaparking.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Texas A&M San Antonio");
        public string Name => "Texas A&M San Antonio";
        public string State => "TX";
        public string Link => "https://tamusaparking.t2hosted.com";
