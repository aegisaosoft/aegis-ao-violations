...
{
    public class ModestoFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://modesto.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Modesto");
        public string Name => "Modesto";
        public string State => "CA";
        public string Link => "https://modesto.t2hosted.com";
