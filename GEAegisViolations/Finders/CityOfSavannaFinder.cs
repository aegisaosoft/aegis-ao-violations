...
namespace GEAegisViolations.Finders
{
    public class CityOfSavannaFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://cityofsavannah.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Savanna City");
        public string Name => "Savanna City";
        public string State => "GE";
