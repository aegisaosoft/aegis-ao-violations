...
{
    public class ParkingIuFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://parkingiu.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Indiana University");
        public string Name => "Indiana University";
        public string State => "IN";
        public string Link => "https://parkingiu.t2hosted.com";
