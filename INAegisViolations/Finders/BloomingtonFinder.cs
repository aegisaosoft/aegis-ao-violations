...
{
    public class BloomingtonFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://bloomington.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Bloomington");
        public string Name => "Bloomington";
        public string State => "IN";
        public string Link => "https://bloomington.t2hosted.com";
