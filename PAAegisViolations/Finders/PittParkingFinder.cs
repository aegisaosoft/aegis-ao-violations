...
{
    public class PittParkingFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://pittparking.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "University of Pittsburgh");
        public string Name => "University of Pittsburgh";
        public string State => "PA";
        public string Link => "https://pittparking.t2hosted.com";
