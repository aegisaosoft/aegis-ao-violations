...
{
    public class PsuFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://psu.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Penn State University (University Park)");
        public string Name => "Penn State University (University Park)";
        public string State => "PA";
        public string Link => "https://psu.t2hosted.com";
