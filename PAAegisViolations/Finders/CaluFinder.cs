...
namespace PAAegisViolations.Finders
{
    public class CaluFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://calu.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "California University of Pennsylvania (PennWest)");
        public string Name => "California University of Pennsylvania (PennWest)";
        public string State => "PA";
        public string Link => "https://calu.t2hosted.com";
