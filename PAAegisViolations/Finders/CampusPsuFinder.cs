...
{
    public class CampusPsuFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://campus-psu.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Penn State Behrend");
        public string Name => "Penn State Behrend";
        public string State => "PA";
        public string Link => "https://campus-psu.t2hosted.com";
