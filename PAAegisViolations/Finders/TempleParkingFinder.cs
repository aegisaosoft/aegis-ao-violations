...
{
    public class TempleParkingFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://templeparking.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Temple University");
        public string Name => "Temple University";
        public string State => "PA";
        public string Link => "https://templeparking.t2hosted.com";
