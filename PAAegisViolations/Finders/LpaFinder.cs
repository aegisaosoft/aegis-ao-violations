...
{
    public class LpaFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://lpa.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Lancaster Parking Authority");
        public string Name => "Lancaster Parking Authority";
        public string State => "PA";
        public string Link => "https://lpa.t2hosted.com";
