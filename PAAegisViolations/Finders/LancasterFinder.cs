...
{
    public class LancasterFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://lancaster.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Lancaster");
        public string Name => "Lancaster";
        public string State => "PA";
        public string Link => "https://lancaster.t2hosted.com";
