...
namespace SCAegisViolations.Finders
{
    public class ColumbiaScFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://columbiasc.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Columbia");
        public string Name => "Columbia";
        public string State => "SC";
        public string Link => "https://columbiasc.t2hosted.com";
