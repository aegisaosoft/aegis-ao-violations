...
namespace DEAegisViolations.Finders
{
    public class RehobothBeachFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://rehobothbeach.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Rehoboth Beach");
        public string Name => "Rehoboth Beach";
        public string State => "DE";
        public string Link => "https://rehobothbeach.t2hosted.com";
