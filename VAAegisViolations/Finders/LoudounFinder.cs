...
namespace VAAegisViolations.Finders
{
    public class LoudounFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://loudoun.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Loudoun County");
        public string Name => "Loudoun County";
        public string State => "VA";
        public string Link => "https://loudoun.t2hosted.com";
