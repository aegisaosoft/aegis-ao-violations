...
{
    internal class TampaFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "tampaparking.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Tampa");
        public string Name => "Tampa";
