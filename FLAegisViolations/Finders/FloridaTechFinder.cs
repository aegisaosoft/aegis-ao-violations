...
{
    public class FloridaTechFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://floridatech.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "Florida Tech");
        public string Name => "Florida Tech";
        public string State => "FL";
        public string Link => "https://floridatech.t2hosted.com";
