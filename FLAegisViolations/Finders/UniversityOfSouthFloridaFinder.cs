...
{
    public class UniversityOfSouthFloridaFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "usfpts.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "University of South Florida");
        public string Name => "University of South Florida";
        public string State => "FL";
        public string Link => $"https://{_url}";
