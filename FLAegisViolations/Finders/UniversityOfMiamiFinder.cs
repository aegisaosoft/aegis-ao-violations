...
{
    public class UniversityOfMiamiFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://universityofmiami.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "University of Miami");
        public string Name => "University of Miami";
        public string State => "FL";
        public string Link => "https://universityofmiami.t2hosted.com";
