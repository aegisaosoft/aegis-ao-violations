...
{
    public class TapsFinder : AHttpFinder, IAegisAPIFinder
    {
        protected static string _url = "https://taps.t2hosted.com";
        protected PortalHelper helper = new PortalHelper(_url, "University of Florida");
        public string Name => "University of Florida";
        public string State => "FL";
        public string Link => "https://taps.t2hosted.com";
